...
import "@assets/styles/components/Settings/SettingsDisplay/DesktopPositionInput.scss"
...
export default function DesktopPositionInput({label, value, onChange, helpText, options = defaultOptions}) {
  return (
